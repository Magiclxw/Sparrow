...
const esp_efuse_desc_t* ESP_EFUSE_STRAP_JTAG_SEL1[] = {
...
{
    uint8_t efuse = 0;
    //printf("***************result = %d",esp_efuse_write_field_bit(ESP_EFUSE_STRAP_JTAG_SEL1));

    efuse = esp_efuse_read_field_bit(ESP_EFUSE_STRAP_JTAG_SEL1);

    printf("efuse = %d",efuse);
}
