...
#define SERVO_MIN_PULSEWIDTH_US 1000//500  // Minimum pulse width in microsecond
#define SERVO_MAX_PULSEWIDTH_US 2000//2500  // Maximum pulse width in microsecond
#define SERVO_MIN_DEGREE        0//-90   // Minimum angle
